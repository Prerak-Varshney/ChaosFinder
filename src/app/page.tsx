...
export default function Home() {
  ...
  return (
    <div className={`w-full h-full`}>
      ...
      {
        searchType === 'Genre' && !shouldFetch ? <div className={`w-full h-[calc(100vh-5rem)] flex items-center justify-center text-pink-300 bg-gray-950 text-2xl font-bold`}><h1>Coming Soon...</h1></div> : !shouldFetch ? <div className={`w-full h-[calc(100vh-5rem)]`}><Welcome /></div> : (
          <>
            {
